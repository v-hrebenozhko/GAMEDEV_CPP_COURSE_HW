...
public:
	...
	const int getDifficultyHeightGap() const { return m_difficultyHeightGap; }

	void generateProjectile(std::vector<std::unique_ptr<Projectile>>& projectiles, Player& player);
