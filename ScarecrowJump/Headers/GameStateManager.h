...
public:
	...
	void loadSave();
	void saveGame(std::vector<std::string> saveData) { m_saveManager.save(m_saveFileName, saveData); }
	...
	const bool getIsSaveValid() const { return m_saveManager.getIsSaveValid(); }
