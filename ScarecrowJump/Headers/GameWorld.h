...
{
public:
	static void createInstance(sf::RenderWindow* window) { ms_gameWorld = new GameWorld(window); }
	 
	static void destroyInstance() { delete ms_gameWorld; }
	...
	void proccesProjectiles(float deltaTime);
